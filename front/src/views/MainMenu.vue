  ...
  <div id="main-menu" v-if="state.gameState === 'menu' ">
    ...
    <div v-else-if="state.menuView === 'ai'" class="deck-selection-menu">
      ...
      <div v-else class="no-decks">
        ...
        <AppButton variant="primary" @click="openDecks">CRÉER UN DECK</AppButton>
      </div>
    ...
    <div v-else-if="state.menuView === 'multi'" class="difficulty-options multi-menu">
      ...
      <div v-if="!multiState.hosting && !multiState.joining" class="menu-buttons multi-buttons">
        <AppButton fullWidth variant="primary" class="text-lg py-4 shadow-lg shadow-primary/20" @click="hostGame">Héberger une partie</AppButton>
        <AppButton fullWidth variant="primary" class="text-lg py-4 shadow-lg shadow-primary/20" @click="multiState.joining = true">Rejoindre une partie</AppButton>
      ...
      <div v-else-if="multiState.joining" class="join-panel">
        ...
        <AppButton variant="primary" @click="joinGame" class="join-btn" :disabled="multiState.loading">
